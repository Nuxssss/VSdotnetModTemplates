...
public sealed class BuildTask : FrostingTask<BuildContext>
{
    public override void Run(BuildContext context)
    {
        context.DotNetClean($"../{BuildContext.ProjectName}/{BuildContext.ProjectName}.fsproj",
        ...
        context.DotNetPublish($"../{BuildContext.ProjectName}/{BuildContext.ProjectName}.fsproj",
